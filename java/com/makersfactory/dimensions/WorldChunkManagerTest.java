...
public class WorldChunkManagerTest extends WorldChunkManager {
	...
	protected WorldChunkManagerTest()
	{
	...
	public WorldChunkManagerTest(long seed, WorldType worldtype)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = GenLayerTest.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerTest(World world)
	{
